...
public class StoryDataArrayAdaptor extends ArrayAdapter<StoryData> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			long storyId = item.storyId;
			String title = item.title;
			long creationTime = item.creationTime;
			...
			TextView storyIdTV = (TextView) todoView
					.findViewById(R.id.story_listview_custom_row_story_id_textView);
			...
			storyIdTV.setText("" + item.tags.toString());
			titleTV.setText("" + title);
			creationTimeTV.setText("" + getStringDate(storyDate));
