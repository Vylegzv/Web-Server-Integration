...
public class TagsDataArrayAdaptor extends ArrayAdapter<TagsData> {

    private static final String LOG_TAG = TagsDataArrayAdaptor.class
            .getCanonicalName();

    int resource;

    public TagsDataArrayAdaptor(Context _context, int _resource,
            List<TagsData> _items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            TagsData item = getItem(position);
            ...
            if (convertView == null) {
                ...
                todoView = (LinearLayout) convertView;
                    ...
                    .findViewById(R.id.tags_listview_custom_row_KEY_ID_textView);
