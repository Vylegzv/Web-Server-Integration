...
/**
 * Fragments require a Container Activity, this is the one for the View TagsData
 */
public class ViewTagsActivity extends TagsActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            long index = getIntent().getExtras().getLong(
                    TagsViewFragment.rowIdentifyerTAG);
