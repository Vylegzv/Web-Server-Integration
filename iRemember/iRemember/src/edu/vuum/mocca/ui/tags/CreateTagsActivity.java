...
/**
 * Fragments require a Container Activity, this is the one for the Create
 * StoryData
 */
public class CreateTagsActivity extends TagsActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            CreateTagsFragment creator = CreateTagsFragment.newInstance();
