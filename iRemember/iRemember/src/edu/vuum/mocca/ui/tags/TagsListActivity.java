...
/**
 * Fragments require a Container Activity, this is the one for the List TagsData
 */
public class TagsListActivity extends TagsActivityBase {
    private static final String LOG_TAG = TagsListActivity.class
            .getCanonicalName();
