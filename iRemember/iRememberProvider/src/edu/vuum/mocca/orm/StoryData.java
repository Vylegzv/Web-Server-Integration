...
public class StoryData implements Parcelable {
	...
	public boolean needsSyncedLocally = false;
	...
	private static String getString(JSONObject jsonObject, String value)
			throws JSONException {
		String key = null;
		if (jsonObject.has(value)) {
			if (!jsonObject.isNull(value)) {
				key = (String) jsonObject.get(value);
			} else {
				key = null;
			}
		}
	...
	public static StoryData createObjectFromJSON(JSONObject jsonObject)
		...
		String body = getString(bodyJson, "value");
		String audioLink = getString(jsonObject, "audioLink");
		String videoLink = getString(jsonObject, "videoLink");
		String imageName = getString(jsonObject, "imageName");
		String imageMetaData = getString(jsonObject, "imageMetaData");
		String tags = getString(jsonObject, "tags");
		String key = getString(jsonObject, "key");
		String href = getString(jsonObject, "href");
		long creationTime = jsonObject.getLong("creationTime");
		long storyTime = jsonObject.getLong("storyTime");
		double latitude = jsonObject.getDouble("latitude");
		double longitude = jsonObject.getDouble("longitude");

		Log.v("StoryData", "key:" + key);
		return new StoryData(key, href, loginId, storyId, title, body,
	 ...
	 * @param longitude
	 */
	public StoryData(String key, String href, long row_id, long loginId,
			long storyId, String title, String body, String audioLink,
			String videoLink, String imageName, String imageMetaData,
			String tags, long creationTime, long storyTime, double latitude,
			double longitude) {
