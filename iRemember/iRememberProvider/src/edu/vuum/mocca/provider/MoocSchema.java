...
public class MoocSchema {
	...
	public static class Story {
		...
		public static final String[] ALL_COLUMN_NAMES = {
				...
				Cols.STORY_TIME, Cols.LATITUDE, Cols.LONGITUDE, Cols.KEY,
				Cols.HREF
		...
		public static ContentValues initializeWithDefault(
			...
			if (!setValues.containsKey(Cols.KEY)) {
				setValues.put(Cols.KEY, 0);
			}
			if (!setValues.containsKey(Cols.HREF)) {
				setValues.put(Cols.HREF, 0);
			}
			return setValues;
		}
