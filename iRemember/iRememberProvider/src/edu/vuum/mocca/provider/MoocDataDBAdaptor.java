 ...
 * 
 */
public class MoocDataDBAdaptor {

    private static final String LOG_TAG = MoocDataDBAdaptor.class
            .getCanonicalName();
    ...
    private static final String Story_key = MoocSchema.Story.Cols.KEY;
    private static final String Story_href = MoocSchema.Story.Cols.HREF;
     ...
     * @param _context
     */
    public MoocDataDBAdaptor(Context _context) {
     ...
     * @param _context
     */
    public MoocDataDBAdaptor(Context _context, boolean memory_only_db) {
