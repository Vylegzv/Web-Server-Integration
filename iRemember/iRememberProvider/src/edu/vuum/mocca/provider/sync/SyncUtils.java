...
import edu.vuum.mocca.authentication.AccountAuthenticatorService;
...
public class SyncUtils {
	...
	private static final String CONTENT_AUTHORITY = MoocSchema.AUTHORITY;
	...
	public static void CreateSyncAccount(Context context) {
		...
		// deleted account.)
		Account account = AccountAuthenticatorService.GetDefaultSyncAccount();
	...
	public static void TriggerRefresh() {
		...
		ContentResolver.requestSync(AccountAuthenticatorService.GetDefaultSyncAccount(), // Sync
				// account
